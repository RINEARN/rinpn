...
public class PowXfci1PluginTest {
	...
	public void testDoubleScalar() throws ConnectorException {
		...
		exponentDataContainer.setArrayData(new double[] { 2.3 }, 0, ArrayDataAccessorInterface1.ARRAY_LENGTHS_OF_SCALAR);
	...
	public void testDoubleArrayElement() throws ConnectorException {
		...
		exponentDataContainer.setArrayData(new double[] { 1.1, 2.3, 3.6 }, 1, ArrayDataAccessorInterface1.ARRAY_LENGTHS_OF_SCALAR);
